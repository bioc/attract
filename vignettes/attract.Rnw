...
attractor.states <- findAttractors(loring.eset, "celltype", 
                                   ...
                                   databaseGeneFormat=NULL)
@

\begin{flushleft}
The output of the \texttt{findAttractors} object is is an S4 class \texttt{AttractorModuleSet} object. \\
\end{flushleft}
...
\begin{flushleft}
[2] Mar JC, Wells CA, Quackenbush J. 2010. Identifying Gene Expression Modules that Represent the Drivers of Kauffman's 
...
\begin{flushleft}
[4] Mar JC, Wells CA, Quackenbush J. 2010. Defining an Informativeness Metric for Clustering Gene Expression Data. To Appear.\\
\end{flushleft}
